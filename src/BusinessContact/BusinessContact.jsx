...
import business from "./forbusiness.png";
import { useDispatch, useSelector } from "react-redux";
import { removeBusiness } from "../Context";
const BusinessContact = () => {
  const data = useSelector((state) => state.myReducer.business);
  const dispatch = useDispatch();
  return (
    <>
      <Text>All your Business Contacts!!! </Text>
      <br />

      <Forphoto>
        <Photo src={business} alt="image" />
      </Forphoto>
      <br />
      <br />
      <br />
            ...
            {data.map((props) => (
              <Card>
                ...
                <But>
                  <Button
                    onClick={() => {
                      dispatch(removeBusiness(props));
                    }}
                  >
                    Remove as business partner
                  </Button>
                </But>
              </Card>
            ))}
